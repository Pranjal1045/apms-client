...
export const createStudent = createAsyncThunk(
  "createStudent", async(data, thunkAPI) => {
    try {
...
export const updateStudent = createAsyncThunk(
  "updateStudent", async({id, data}, thunkAPI) => {
    try {
...
export const deleteStudent = createAsyncThunk(
  "deleteStudent", async(id, thunkAPI) => {
    try {
...
export const createTeacher = createAsyncThunk(
  "createTeacher", async(data, thunkAPI) => {
    try {
...
export const updateTeacher = createAsyncThunk(
  "updateTeacher", async({id, data}, thunkAPI) => {
    try {
...
export const deleteTeacher = createAsyncThunk(
  "deleteTeacher", async(id, thunkAPI) => {
    try {
...
export const getAllProjects = createAsyncThunk(
  "getAllProjects", async(_, thunkAPI) => {
    try {
...
export const getDashboardStats = createAsyncThunk(
  "getDashboardStats", async(_, thunkAPI) => {
    try {
...
export const assignSupervisor = createAsyncThunk(
  "assignSupervisor", async(data, thunkAPI) => {
    try {
...
export const approveProject = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      return id; // return id so reducer can update by id
    } catch (error) {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createStudent.fulfilled, (state, action) => {
        // unshift puts new student at top of list
